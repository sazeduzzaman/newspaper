...
import { KhelarNewsProps } from "@/lib/types/KhelarNewsProps";
import Link from "next/link";
import React from "react";

const KhelarNewsItems = ({ khelarNewsData }: KhelarNewsProps) => {
  console.log(khelarNewsData);
  const featured = khelarNewsData.filter((item: any) => item.is_featured === 1);
  const nonFeatured = khelarNewsData.filter(
...
export default KhelarNewsItems;
